...
public class BoyActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent i1=new Intent(this,ShoppingBoy.class);
		spec1.setContent(i1);
		...
		Intent i2=new Intent(this,DailyRoutineBoy.class);
		spec2.setContent(i2);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_boy, menu);
		return true;
	}
